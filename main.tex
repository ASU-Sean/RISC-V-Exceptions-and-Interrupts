...
\node (dec1) [decision, below of=start1, yshift =-2cm] {{\tt{medeleg[mcause]}} == 1?};
\node (pro1) [process, below of=dec1, xshift=3.5cm, yshift=-2cm] {Route to M-mode exception handler};
\node (dec2) [decision, below of=dec1, xshift=-3.5cm, yshift=-4cm] {{\tt{sedeleg[scause]}} == 1?};
\node (pro2) [process, below of=dec2, xshift=5cm, yshift=-2cm] {Route to S-mode exception handler};
\node (pro3) [process, below of=dec2, xshift=-5cm, yshift=-2cm] {Route to U-mode exception handler};
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.7]{PLIC and CLINT Block Diagram.JPG}
    \caption{Block diagram of an example PLIC and CLINT configuration \cite{CLINT}}
    \label{PLIC_CLINT}
\end{figure}
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.7]{PLIC and CLIC Block Diagram.JPG}
    \caption{Block diagram of an example PLIC and CLIC configuration \cite{CLINT}}
    \label{PLIC_CLIC}
\end{figure}
